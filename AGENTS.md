...
- **Identité visuelle** : palette « Registre libre » pour FkCloud Share (surfaces crème/sombre, bleu primaire, bordures fil au lieu des ombres Material3) — implémentée dans les thèmes `apps/`.
